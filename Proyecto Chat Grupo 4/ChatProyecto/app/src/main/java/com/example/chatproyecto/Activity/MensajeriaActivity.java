...
import com.example.chatproyecto.DAOS.MensajeriaDAO;
...
public class MensajeriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("Mensajes");
        ...
        FirebaseDatabase.
                getInstance().getReference(Invariable.TABLA_MJS).
        ...
        super.onResume();
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Glide.with(MensajeriaActivity.this).load(foto).into(fotoPerfil);
